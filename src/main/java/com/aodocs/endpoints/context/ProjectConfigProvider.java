...
public class ProjectConfigProvider {
	...
	public static void override(String applicationId, ProjectsClient projectsClient, Iam iamClient) {
		INSTANCE = new ProjectConfigProvider(applicationId, projectsClient, iamClient);
	}
	...
	private ProjectConfigProvider(String applicationId, @Nullable ProjectsClient projectsClient, Iam iamClient) {
	...
	private ProjectsClient getProjectsClient() {
		return projectsClient != null ? projectsClient : ProjectsClient.create();
	}
