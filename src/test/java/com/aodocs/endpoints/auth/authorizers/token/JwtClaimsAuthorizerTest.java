...
public class JwtClaimsAuthorizerTest {
	...
	@Test
	public void testAllClaims() throws IOException {
	...
	@Test
	public void testAnyClaim() throws IOException {
	...
	public void testUnsupportedArray() throws IOException {
		assertTrue(assertThrows(IllegalStateException.class, () -> new AllJwtClaimsAuthorizer(ImmutableMap.of(
				"firebase/identities/email", "vitob14022@tst999.com" //valid
		)).checkJwtClaims(loadPayload())).getMessage().contains("ARRAY"));
	}
	...
	public void testUnsupportedObject() throws IOException {
		...
		)).checkJwtClaims(loadPayload())).getMessage().contains("OBJECT"));
	}
