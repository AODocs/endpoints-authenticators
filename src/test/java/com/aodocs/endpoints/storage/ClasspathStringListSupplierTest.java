 ...
 */
public class ClasspathStringListSupplierTest {

    @Test
    public void testGet() {
        assertEquals(ImmutableList.of("1", "2", "3"), new ClasspathStringListSupplier("list.txt").get());
    }

    @Test
    public void testMissingWithoutFailOnMissing() {
        //non-existing files should give an empty list
        assertEquals(ImmutableList.of(), new ClasspathStringListSupplier("doesnotexist", false).get());
    }
